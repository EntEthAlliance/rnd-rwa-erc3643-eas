 ...
 * @dev Behavioural parity with `EASTrustedIssuersAdapter` — Schema-2-backed
 *      authorization (audit C-5) and per-topic attester cap of 5.
 */
    ...
    IEASTrustedIssuersAdapter
{
    ...
    /// @dev Reserved storage gap — reduced by 2 slots for `_eas` and `_issuerAuthSchemaUID`.
